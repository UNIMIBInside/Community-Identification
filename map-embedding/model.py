...
def Map_Embedding2(include_top=True,
    ...
    output_layers.append(layers.Dense(3, activation='softmax', name=name + f'_output{classes-2}')(task_layers[classes-2]))
    output_layers.append(layers.Dense(3, activation='softmax', name=name + f'_output{classes-1}')(task_layers[classes-1]))
